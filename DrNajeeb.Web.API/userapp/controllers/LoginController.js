(function (app) {
    ...
    var LoginController = function ($scope, $timeout, $location, $rootScope, Facebook, OAuthService, CurrentUserService, loginRedirect, toastr) {
        ...
        $scope.vcmodel = {
            key: '6Ldxiw4TAAAAALjGjyCct8zwhn25C3bV-oCcvch2'
        };
        ...
        var onLogin = function (data) {
            if (!data) {
                $scope.fullName = prompt("Please enter your full name");
                $scope.setFullName();
                return false;
            }
        ...
        var onNameEnterSuccess = function (data) {
            toastr.success("Welcome " + $scope.fullName);
            loginRedirect.redirectPostLogin();
            $rootScope.updateUserImage();
        }
