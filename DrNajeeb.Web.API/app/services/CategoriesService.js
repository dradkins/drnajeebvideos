...
(function (app) {
    ...
    var CategoriesService = function ($http) {
        ...
        CategoriesService.getVideoCategories = function () {
        ...
        CategoriesService.updateOrder = function (categoryOrder) {
            return $http.post("/api/category/updateOrder", categoryOrder)
                        .then(function (response) {
                            return response.data;
                        });
        };
